...
\nwnotused{Test two formulas for equality}\nwidentdefs{\\{{\nwixident{EqFrms}}{EqFrms}}}\nwidentuses{\\{{\nwixident{ConjFrmPtr}}{ConjFrmPtr}}\\{{\nwixident{Constr}}{Constr}}\\{{\nwixident{ConstrPtr}}{ConstrPtr}}\\{{\nwixident{EqTrmLists}}{EqTrmLists}}\\{{\nwixident{EqTrms}}{EqTrms}}\\{{\nwixident{EqTyps}}{EqTyps}}\\{{\nwixident{FrmPtr}}{FrmPtr}}\\{{\nwixident{NegFrmPtr}}{NegFrmPtr}}\\{{\nwixident{PredFrmPtr}}{PredFrmPtr}}\\{{\nwixident{QualFrmPtr}}{QualFrmPtr}}\\{{\nwixident{TrmList}}{TrmList}}\\{{\nwixident{UnivFrmPtr}}{UnivFrmPtr}}}\nwindexuse{\nwixident{ConjFrmPtr}}{ConjFrmPtr}{NW4MEPPp-3iPvQ-1}\nwindexuse{\nwixident{Constr}}{Constr}{NW4MEPPp-3iPvQ-1}\nwindexuse{\nwixident{ConstrPtr}}{ConstrPtr}{NW4MEPPp-3iPvQ-1}\nwindexuse{\nwixident{EqTrmLists}}{EqTrmLists}{NW4MEPPp-3iPvQ-1}\nwindexuse{\nwixident{EqTrms}}{EqTrms}{NW4MEPPp-3iPvQ-1}\nwindexuse{\nwixident{EqTyps}}{EqTyps}{NW4MEPPp-3iPvQ-1}\nwindexuse{\nwixident{FrmPtr}}{FrmPtr}{NW4MEPPp-3iPvQ-1}\nwindexuse{\nwixident{NegFrmPtr}}{NegFrmPtr}{NW4MEPPp-3iPvQ-1}\nwindexuse{\nwixident{PredFrmPtr}}{PredFrmPtr}{NW4MEPPp-3iPvQ-1}\nwindexuse{\nwixident{QualFrmPtr}}{QualFrmPtr}{NW4MEPPp-3iPvQ-1}\nwindexuse{\nwixident{TrmList}}{TrmList}{NW4MEPPp-3iPvQ-1}\nwindexuse{\nwixident{UnivFrmPtr}}{UnivFrmPtr}{NW4MEPPp-3iPvQ-1}\nwendcode{}\nwbegindocs{32}\nwdocspar
...
\nwnotused{Dispose term recurse and list}\nwidentdefs{\\{{\nwixident{DisposeTrmRecAndList}}{DisposeTrmRecAndList}}}\nwidentuses{\\{{\nwixident{FuncTrmPtr}}{FuncTrmPtr}}\\{{\nwixident{TrmList}}{TrmList}}}\nwindexuse{\nwixident{FuncTrmPtr}}{FuncTrmPtr}{NW4MEPPp-3MAeyg-1}\nwindexuse{\nwixident{TrmList}}{TrmList}{NW4MEPPp-3MAeyg-1}\nwendcode{}\nwbegindocs{40}\nwdocspar
...
\nwnotused{Choice constructor}\nwidentuses{\\{{\nwixident{ChConstrObj}}{ChConstrObj}}\\{{\nwixident{FuncTrmPtr}}{FuncTrmPtr}}\\{{\nwixident{TrmPtr}}{TrmPtr}}}\nwindexuse{\nwixident{ChConstrObj}}{ChConstrObj}{NW4MEPPp-UuAXD-1}\nwindexuse{\nwixident{FuncTrmPtr}}{FuncTrmPtr}{NW4MEPPp-UuAXD-1}\nwindexuse{\nwixident{TrmPtr}}{TrmPtr}{NW4MEPPp-UuAXD-1}\nwendcode{}\nwbegindocs{42}\nwdocspar
...
\nwused{\\{NW4MEPPp-1KdKcq-1}}\nwidentdefs{\\{{\nwixident{YCluster}}{YCluster}}}\nwidentuses{\\{{\nwixident{AttrCollectionPtr}}{AttrCollectionPtr}}\\{{\nwixident{AttrPtr}}{AttrPtr}}\\{{\nwixident{YAttr}}{YAttr}}}\nwindexuse{\nwixident{AttrCollectionPtr}}{AttrCollectionPtr}{NW4MEPPp-1RVFLZ-1}\nwindexuse{\nwixident{AttrPtr}}{AttrPtr}{NW4MEPPp-1RVFLZ-1}\nwindexuse{\nwixident{YAttr}}{YAttr}{NW4MEPPp-1RVFLZ-1}\nwendcode{}\nwbegindocs{56}\nwdocspar
...
\nwused{\\{NW4MEPPp-1KdKcq-1}}\nwidentdefs{\\{{\nwixident{YFormula}}{YFormula}}}\nwidentuses{\\{{\nwixident{BoundVarNbr}}{BoundVarNbr}}\\{{\nwixident{ConjFrmPtr}}{ConjFrmPtr}}\\{{\nwixident{FlexFrmPtr}}{FlexFrmPtr}}\\{{\nwixident{FrmPtr}}{FrmPtr}}\\{{\nwixident{NegFrmPtr}}{NegFrmPtr}}\\{{\nwixident{PredFrmPtr}}{PredFrmPtr}}\\{{\nwixident{QualFrmPtr}}{QualFrmPtr}}\\{{\nwixident{UnivFrmPtr}}{UnivFrmPtr}}\\{{\nwixident{YTerm}}{YTerm}}\\{{\nwixident{YTermList}}{YTermList}}\\{{\nwixident{YType}}{YType}}}\nwindexuse{\nwixident{BoundVarNbr}}{BoundVarNbr}{NW4MEPPp-2R1rnI-1}\nwindexuse{\nwixident{ConjFrmPtr}}{ConjFrmPtr}{NW4MEPPp-2R1rnI-1}\nwindexuse{\nwixident{FlexFrmPtr}}{FlexFrmPtr}{NW4MEPPp-2R1rnI-1}\nwindexuse{\nwixident{FrmPtr}}{FrmPtr}{NW4MEPPp-2R1rnI-1}\nwindexuse{\nwixident{NegFrmPtr}}{NegFrmPtr}{NW4MEPPp-2R1rnI-1}\nwindexuse{\nwixident{PredFrmPtr}}{PredFrmPtr}{NW4MEPPp-2R1rnI-1}\nwindexuse{\nwixident{QualFrmPtr}}{QualFrmPtr}{NW4MEPPp-2R1rnI-1}\nwindexuse{\nwixident{UnivFrmPtr}}{UnivFrmPtr}{NW4MEPPp-2R1rnI-1}\nwindexuse{\nwixident{YTerm}}{YTerm}{NW4MEPPp-2R1rnI-1}\nwindexuse{\nwixident{YTermList}}{YTermList}{NW4MEPPp-2R1rnI-1}\nwindexuse{\nwixident{YType}}{YType}{NW4MEPPp-2R1rnI-1}\nwendcode{}\nwbegindocs{60}\nwdocspar
...
\nwnotused{Check if attribute is strict}\nwidentdefs{\\{{\nwixident{IsStrict}}{IsStrict}}}\nwidentuses{\\{{\nwixident{AttrPtr}}{AttrPtr}}\\{{\nwixident{Constr}}{Constr}}\\{{\nwixident{ConstrPtr}}{ConstrPtr}}}\nwindexuse{\nwixident{AttrPtr}}{AttrPtr}{NW4MEPPp-ktNEN-1}\nwindexuse{\nwixident{Constr}}{Constr}{NW4MEPPp-ktNEN-1}\nwindexuse{\nwixident{ConstrPtr}}{ConstrPtr}{NW4MEPPp-ktNEN-1}\nwendcode{}\nwbegindocs{162}\nwdocspar
...
\nwnotused{Check if a cluster is a complex number}\nwidentdefs{\\{{\nwixident{IsComplexNumber}}{IsComplexNumber}}}\nwidentuses{\\{{\nwixident{AttrCollectionPtr}}{AttrCollectionPtr}}\\{{\nwixident{AttrPtr}}{AttrPtr}}}\nwindexuse{\nwixident{AttrCollectionPtr}}{AttrCollectionPtr}{NW4MEPPp-z6Fof-1}\nwindexuse{\nwixident{AttrPtr}}{AttrPtr}{NW4MEPPp-z6Fof-1}\nwendcode{}\nwbegindocs{172}\nwdocspar
...
\nwnotused{Check if a term list is the empty set}\nwidentdefs{\\{{\nwixident{IsItEmptySet}}{IsItEmptySet}}}\nwidentuses{\\{{\nwixident{FuncTrmPtr}}{FuncTrmPtr}}\\{{\nwixident{TrmList}}{TrmList}}}\nwindexuse{\nwixident{FuncTrmPtr}}{FuncTrmPtr}{NW4MEPPp-2jO3Qb-1}\nwindexuse{\nwixident{TrmList}}{TrmList}{NW4MEPPp-2jO3Qb-1}\nwendcode{}\nwbegindocs{178}\nwdocspar
...
\nwnotused{Verify contradiction}\nwidentdefs{\\{{\nwixident{ContradictionVerify}}{ContradictionVerify}}}\nwidentuses{\\{{\nwixident{AttrPtr}}{AttrPtr}}\\{{\nwixident{Constr}}{Constr}}\\{{\nwixident{ConstrPtr}}{ConstrPtr}}\\{{\nwixident{EqFrms}}{EqFrms}}\\{{\nwixident{FrmPtr}}{FrmPtr}}\\{{\nwixident{NegBas}}{NegBas}}\\{{\nwixident{PosBas}}{PosBas}}\\{{\nwixident{PredFrmPtr}}{PredFrmPtr}}\\{{\nwixident{QualFrmPtr}}{QualFrmPtr}}\\{{\nwixident{SetContr}}{SetContr}}\\{{\nwixident{TrmPtr}}{TrmPtr}}\\{{\nwixident{TypPtr}}{TypPtr}}}\nwindexuse{\nwixident{AttrPtr}}{AttrPtr}{NW4MEPPp-ZKp2x-1}\nwindexuse{\nwixident{Constr}}{Constr}{NW4MEPPp-ZKp2x-1}\nwindexuse{\nwixident{ConstrPtr}}{ConstrPtr}{NW4MEPPp-ZKp2x-1}\nwindexuse{\nwixident{EqFrms}}{EqFrms}{NW4MEPPp-ZKp2x-1}\nwindexuse{\nwixident{FrmPtr}}{FrmPtr}{NW4MEPPp-ZKp2x-1}\nwindexuse{\nwixident{NegBas}}{NegBas}{NW4MEPPp-ZKp2x-1}\nwindexuse{\nwixident{PosBas}}{PosBas}{NW4MEPPp-ZKp2x-1}\nwindexuse{\nwixident{PredFrmPtr}}{PredFrmPtr}{NW4MEPPp-ZKp2x-1}\nwindexuse{\nwixident{QualFrmPtr}}{QualFrmPtr}{NW4MEPPp-ZKp2x-1}\nwindexuse{\nwixident{SetContr}}{SetContr}{NW4MEPPp-ZKp2x-1}\nwindexuse{\nwixident{TrmPtr}}{TrmPtr}{NW4MEPPp-ZKp2x-1}\nwindexuse{\nwixident{TypPtr}}{TypPtr}{NW4MEPPp-ZKp2x-1}\nwendcode{}\nwbegindocs{202}\nwdocspar
